...
MeshLib::Mesh* VtkMeshConverter::convertUnstructuredGrid(vtkUnstructuredGrid* grid)
{
	...
	for (size_t i = 0; i < nElems; i++)
	{
		...
		case VTK_LINE: {
			...
			elem = new MeshLib::Line(line_nodes, i);
			break;
		}
		case VTK_TRIANGLE: {
			...
			elem = new MeshLib::Tri(tri_nodes, i);
			break;
		}
		case VTK_QUAD: {
			MeshLib::Node** quad_nodes = new MeshLib::Node*[4];
		...
		case VTK_TETRA: {
			...
			elem = new MeshLib::Tet(tet_nodes, i);
			break;
		}
		case VTK_HEXAHEDRON: {
			...
			elem = new MeshLib::Hex(hex_nodes, i);
			break;
		}
		case VTK_VOXEL: {
		...
		case VTK_PYRAMID: {
			...
			elem = new MeshLib::Pyramid(pyramid_nodes, i);
			break;
		}
		case VTK_WEDGE: {
